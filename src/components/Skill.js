...
export default () => {
  ...
  return (
    ...
    >
   <SwiperSlide data-aos="fade-up-20"  className="!flex !flex-col !items-center !justify-start !gap-6 p-8 bg-white  transition-colors duration-200 ease-in-out   bg-opacity-10 border-2 border-[#625FB8]  text-white  rounded-md  border-3">
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-[1fr_1fr_1fr] gap-10 h-auto justify-between items-center ">
              <div className="grid w-fit  justify-center transition-transform duration-200 ease-in-out transform hover:scale-110">
                <img
              ...
              <div className="flex flex-col items-center  justify-center w-fit transition-transform duration-200 ease-in-out transform hover:scale-110">
                <img
              ...
              <div className="flex flex-col items-center  justify-center transition-transform duration-200 ease-in-out transform hover:scale-110">
                <img
      ...
      <SwiperSlide data-aos-delay="100" data-aos="fade-up-20" className="!flex !flex-col !items-center !justify-start !gap-6 p-8 bg-white  transition-colors duration-200 ease-in-out   bg-opacity-10 border-2 border-[#625FB8]  text-white rounded-md border-3">
          <div className="flex gap-x-3 items-center ">
            <img
              width="40px"
              height="40px"
        ...
        <SwiperSlide  data-aos="fade-up-20" data-aos-delay="200" className="!flex !flex-col !items-center !justify-start !gap-6 p-8 bg-white  transition-colors duration-200 ease-in-out   bg-opacity-10 border-2 border-[#625FB8]  text-white rounded-md border-3">
          ...
          <div className="grid w-full justify-start ">
            <div className="flex flex-col w-fit transition-transform duration-200 ease-in-out transform hover:scale-110">
              <img
