  ...
  return (
      <div className="App " >
        <section id="home" className=' grid gap-8 md:grid-rows-[5rem_1fr_auto] justify-center md:h-[100vh] h-auto overflow-hidden'>
          <MatrixBackground />
          <Header/><div className='md:block hidden z-50 absolute top-8 right-20'><a target='blank' href={Resume} className=' bg-[#04001E] px-6 py-[10px] rounded-full border-2 transition-all hover:bg-indigo-600 border-indigo-600 '>Resume</a></div>
          <Home/>
          <Mymarquee/>
        </section>
